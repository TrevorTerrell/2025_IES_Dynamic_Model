package MCFR_HyS_BOP
  model Simbase
    ...
    MCFR_HyS_BOP.HeatTransport.PrimaryHeatExchanger PHX(m_dot_pFluidNom_PHX = 45000, m_dot_sFluidNom_PHX = 27272.73, hApnNom_PHX = 20, hAsnNom_PHX = 20) annotation(
      Placement(transformation(origin = {1237, 389}, extent = {{-427, -427}, {427, 427}})));
    MCFR_HyS_BOP.HeatTransport.SecondaryHeatExchanger SHX(m_dot_pFluidNom_SHX = 27272.73, m_dot_sFluidNom_OTSG = 14210.616, m_dot_sFluidNom_HyS = 1291.056, hApnNom_SHX = 9.2014, hAsnNom_SHX = 9.2014) annotation(
      Placement(visible = true, transformation(origin = {1251, -302}, extent = {{-432, -432}, {432, 432}}, rotation = 0)));
    MCFR_HyS_BOP.HeatTransport.OnceThroughSteamGenerator OTSG(m_dot_hitecNom = 14210.616, tauOTSGtoSHX = 10) annotation(
      Placement(transformation(origin = {1420, -1133}, extent = {{-343, -343}, {343, 343}})));
    MCFR_HyS_BOP.HeatTransport.RBOP RBOP(m_dot_fdw_nom = 192.075, omega = 0, sinmag = 0.05, sinstart = 88888888, rampstart = 50000000, ramp_min = 0.2, m_dot_cool_nom = 20000, cooltriptime = 88888888) annotation(
      Placement(visible = true, transformation(origin = {279, -1258}, extent = {{-296, -296}, {296, 296}}, rotation = 0)));
    MCFR_HyS_BOP.HeatTransport.HyS HyS(mdot_H_nom = 1291.056, pressure_nom = 100, Mdot_SA_nom = 3453.3, Mdot_H2O_nom = 345.33, omega = 0, sinmag = 0.01, sinstart = 88888888, rampstart = 5000000, ramp_min = 0.2, sulfouttime = 88888888, prelieffail = 88888888) annotation(
      Placement(transformation(origin = {2431, -918}, extent = {{-296, -296}, {296, 296}})));
    ...
    MCFR_HyS_BOP.Nuclear.DecayHeat decayheat(P = 1200, TotalFuelMass = 638300) annotation(
      Placement(transformation(origin = {-1175, -471}, extent = {{-463, -463}, {463, 463}})));
    ...
    MCFR_HyS_BOP.Nuclear.ReactivityFeedback ReactivityFeedback(a_F = -4.4376e-05, a_R = 0.1164e-05, step_mag = -185*1e-5, omega = 0.1, sin_mag = 1*1e-5, ramp_rate = 11e-5, ramp_mag = 600e-5, stepInsertionTime = 500000000, sinInsertionTime = 88888888, rampInsertionTime = 500000000) annotation(
      Placement(transformation(origin = {-519, -1063}, extent = {{545, -545}, {-545, 545}})));
    MCFR_HyS_BOP.Pumps.PrimaryLoopPump PLP(freeConvectionFF = 0.125, primaryPumpK = 0.092, tripPrimaryPump = 500000000) annotation(
      Placement(transformation(origin = {362, 538}, extent = {{-217, -217}, {217, 217}})));
    MCFR_HyS_BOP.Pumps.SecondaryLoopPump SLP(freeConvectionFF = 0.05, secondaryPumpK = 0.092, tripSecondaryPump = 2000000000) annotation(
      Placement(transformation(origin = {360, -104}, extent = {{-217, -217}, {217, 217}})));
    //MCFR_HyS_BOP.Pumps.TertiaryLoopPump TLP(freeConvectionFF = 0.05, tertiaryPumpK = 0.092, tripTertiaryPump = 2000000000) annotation(    Placement(visible = true, transformation(origin = {375, -583}, extent = {{-217, -217}, {217, 217}}, rotation = 0)));
    MCFR_HyS_BOP.Pumps.OTSG_HotLoopPump SGLP(freeConvectionFF = 0.05, OTSGPumpK = 0.092, tripOTSGPump = 2000000000) annotation(
      Placement(transformation(origin = {356, -562}, extent = {{-217, -217}, {217, 217}})));
    MCFR_HyS_BOP.Pumps.HyS_HotLoopPump HSLP(freeConvectionFF = 0.05, HySPumpK = 0.092, tripHySPump = 2000000000) annotation(
      Placement(transformation(origin = {2430, -388}, extent = {{-217, -217}, {217, 217}})));
  ...
  equation
    connect(PLP.primaryFF, Core.fuelFlowFraction) annotation(
      Line(points = {{362, 412}, {-483, 412}, {-483, -533}}, color = {245, 121, 0}));
    connect(PLP.primaryFF, mPKE.fuelFlowFrac) annotation(
      Line(points = {{362, 412}, {-1184, 412}, {-1184, 479.04}}, color = {245, 121, 0}));
    connect(PLP.primaryFF, PHX.primaryFF) annotation(
      Line(points = {{362, 412}, {643.5, 412}, {643.5, 602.5}, {938, 602.5}}, color = {245, 121, 0}));
    connect(SLP.secondaryFF, SHX.secondaryFF) annotation(
      Line(points = {{360, -234}, {360, -235}, {949, -235}, {949, -86}}, color = {245, 121, 0}));
    connect(SLP.secondaryFF, PHX.secondaryFF) annotation(
      Line(points = {{360, -234}, {360, -235}, {1792, -235}, {1792, 176}}, color = {245, 121, 0}));
//connect(TLP.tertiaryFF, SHX.tertiaryFF) annotation(Line(points = {{375, -713}, {1813, -713}, {1813, -518}}, color = {245, 121, 0}));
  
    connect(SGLP.FF_OTSG, SHX.FF_in_sFluid_OTSG) annotation(
      Line(points = {{356, -692}, {1813, -692}, {1813, -518}}, color = {245, 121, 0}));
    connect(SGLP.FF_OTSG, OTSG.tertiaryFF) annotation(
      Line(points = {{356, -692}, {816, -692}, {816, -934}}, color = {245, 121, 0}));
    connect(HSLP.FF_HyS, HyS.FF_HyS_Hot) annotation(
      Line(points = {{2430, -518}, {2430, -740}, {2431, -740}}, color = {245, 121, 0}));
    connect(HSLP.FF_HyS, SHX.FF_in_sFluid_HyS) annotation(Line(points = {{2430, -518}, {1813, -518}}, color = {245, 121, 0}));
    ...
    connect(Core.nPop, mPKE.n_population) annotation(
      Line(points = {{-705, 233}, {-1014, 233}, {-1014, 159.9}, {-1323, 159.9}}, color = {20, 36, 248}));
    connect(mPKE.n_population, decayheat.nPop) annotation(
      Line(points = {{-1323, 159.58}, {-1323, -369}}, color = {20, 36, 248}));
    connect(mPKE.n_population, Poisons.n_population) annotation(
      Line(points = {{-1323, 159.58}, {-1620, 159.58}, {-1620, -1237}, {-1487, -1237}}, color = {20, 36, 248}));
    connect(decayheat.decayHeat_Out, Core.P_decay) annotation(
      Line(points = {{-1008, -610}, {-908, -610}, {-908, -122}, {-705, -122}}, color = {0, 225, 255}));
    connect(decayheat.decayHeat_Out, PHX.P_decay) annotation(
      Line(points = {{-1008, -610}, {-908, -610}, {-908, 694}, {1357, 694}, {1357, 602.5}}, color = {0, 225, 255}));
    connect(ReactivityFeedback.feedback, mPKE.feedback) annotation(
      Line(points = {{-661, -954}, {-1560, -954}, {-1560, 479}, {-1322.7, 479}}, color = {78, 154, 6}));
    ...
    connect(Core.temp_Out, PHX.T_in_pFluid_PHX) annotation(
      Line(points = {{16.5, 205}, {686, 205}, {686, 517}, {801, 517}}));
    connect(PHX.T_out_pFluid_PHX, Core.temp_In) annotation(
      Line(points = {{1929, 517}, {2050, 517}, {2050, 722}, {-878, 722}, {-878, -477.5}, {-705, -477.5}}));
//connect(TLP.tertiaryFF, OTSG.tertiaryFF) annotation(Line(points = {{375, -713}, {782, -713}, {782, -934}}, color = {245, 121, 0}));
    connect(SHX.T_out_sFluid_OTSG, OTSG.T_in_hitec_OTSG) annotation(
      Line(points = {{819, -432}, {706.5, -432}, {706.5, -1030}, {816, -1030}}));
    connect(OTSG.T_out_hitec_OTSG, SHX.T_in_sFluid_OTSG) annotation(
      Line(points = {{1948, -1030}, {1951, -1030}, {1951, -440}}));
    connect(OTSG.m_dot_SH, RBOP.m_dot_OTSG) annotation(
      Line(points = {{1948, -1359}, {1540.5, -1359}, {1540.5, -1080}, {457, -1080}}, color = {170, 85, 255}));
    connect(RBOP.m_dot_fdw, OTSG.m_dot_fdw) annotation(
      Line(points = {{457, -1436}, {457, -1434}, {816, -1434}, {816, -1359}}, color = {170, 85, 255}));
    connect(OTSG.P_stm, RBOP.P_HP) annotation(
      Line(points = {{1393, -1359}, {1173.5, -1359}, {1173.5, -1080}, {279, -1080}}));
    connect(OTSG.T_SH1, RBOP.T_OTSG) annotation(
      Line(points = {{816, -1236}, {1467.5, -1236}, {1467.5, -1080}, {101, -1080}}));
    connect(RBOP.T_fdw, OTSG.T_fdw) annotation(
      Line(points = {{101, -1436}, {101, -1536}, {2068, -1536}, {2068, -1236}, {1948, -1236}}));
    connect(SHX.T_out_sFluid_HyS, HyS.T_H_in) annotation(
      Line(points = {{820, -432}, {820, -442}, {2253, -442}, {2253, -740}}));
//connect(TLP.tertiaryFF, HyS.FF_HyS_Hot) annotation(Line(points = {{376, -714}, {2355, -714}, {2355, -430}}, color = {245, 121, 0}));
    connect(HyS.T_hot_out, SHX.T_in_sFluid_HyS) annotation(
      Line(points = {{2253, -1096}, {2253, -786}, {1950, -786}, {1950, -388}}));
    annotation(
  ...
  package Nuclear
    ...
    model mPKE
      ...
      parameter MCFR_HyS_BOP.Units.NeutronGenerationTime Lam;
      // These neutronics parameters come from the MCFR-C neutronics model
      parameter MCFR_HyS_BOP.Units.PrecursorDecayConstant lam[6];
      parameter MCFR_HyS_BOP.Units.DelayedNeutronFrac beta[6];
      parameter MCFR_HyS_BOP.Units.ResidentTime tauCoreNom = 7.028;
      // Avg travel time within core
      parameter MCFR_HyS_BOP.Units.ResidentTime tauLoopNom = 7.028;
      // Avg travel time from core outlet to inlet
    ...
    model DecayHeat
      ...
      parameter MCFR_HyS_BOP.Units.DecayHeatYield DHYG1 = 9.635981959409105e-01;
      // Decay heat parameters from the NERTHUS dynamic model
      ...
      parameter MCFR_HyS_BOP.Units.FissFactor FissFactor = 2.464783802008740e-03;
      // Heat per fission relative to nominal power rating
    ...
    model Poisons
      ...
      parameter MCFR_HyS_BOP.Units.IsotopicFissYield gamma_I = 0.06390;
      // Fraction of fissions that directly produce this isotope. Te135's fissyield is added to this one due to its short half live and that it decays into I135
      ...
      parameter MCFR_HyS_BOP.Units.IsotopicDecayConstant I135_lam = 2.926153244511758e-05;
      // Decay constants from https://periodictable.com/Isotopes
      ...
      parameter MCFR_HyS_BOP.Units.MicroAbsorptionCrossSection sig_Xe = 5.915e-24;
      //2.66449e-18; // Cross section for fast spectrum. Commented out is for thermal.
      parameter MCFR_HyS_BOP.Units.MicroAbsorptionCrossSection sig_Sm = 6.763e-24;
      //4.032e-20;
      parameter MCFR_HyS_BOP.Units.MacroAbsorptionCrossSection Sig_f = 0.00129788;
      // Fission cross section of fuel
      parameter MCFR_HyS_BOP.Units.MacroAbsorptionCrossSection Sig_a = 0.00302062;
      // Absorption cross section of fuel
      parameter MCFR_HyS_BOP.Units.NominalNeutronFlux phi_0 = 3.51513E+14;
      // Flux density in core
      parameter MCFR_HyS_BOP.Units.OffgasRemovalRate lam_bubble;
      // Removal rate of fission gases via bubble removal. See Dunkle_2023 "Effect of xenon removal rate on load following in high power thermal spectrum Molten-Salt Reactors (MSRs)" for more info.
    ...
    model ReactivityFeedback
      ...
      parameter MCFR_HyS_BOP.Units.Temperature FuelTempSetPointNode2 = 720;
      // From Terrapower documents
      parameter MCFR_HyS_BOP.Units.Temperature ReflcTempSetPoint = 700;
      parameter MCFR_HyS_BOP.Units.TemperatureReactivityCoef a_F;
      // Fuel temp feedback coefficient. From MCFR-C neutronics modeling
      parameter MCFR_HyS_BOP.Units.TemperatureReactivityCoef a_R;
      // Reflector temp feedback coefficient. From MCFR-C neutronics modeling
      ...
      parameter MCFR_HyS_BOP.Units.Reactivity dollar = 0.007407352;
      // Unused in current version. Can be used for reactivity in cents
...
// For step insertion
      ReactExternalSin = delay(sin_mag*sin(omega*time), sinInsertionTime);
// For sinusoid insertion
      ReactExternalRamp = 0 + (if (time < rampInsertionTime) then 0 else if (time > rampInsertionTime + ramp_mag/ramp_rate) then ramp_mag else ramp_rate*(time - rampInsertionTime));
//For ramp insertion
  ...
  package HeatTransport
    model Core
      ...
      parameter MCFR_HyS_BOP.Units.Mass m_FN1 = 159575;
      // From Terrapower documentation
      parameter MCFR_HyS_BOP.Units.Mass m_FN2 = 159575;
      parameter MCFR_HyS_BOP.Units.Mass m_RN = 969575;
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_fuel = 0.00066065;
      // From Terrapower documentation
      ...
      parameter MCFR_HyS_BOP.Units.Mass m_DHRS = 31915;
      // Mass of fluid in the decay heat removal system (DHRS)
      ...
      parameter MCFR_HyS_BOP.Units.InitiationTime DHRS_time = 2000000000;
      // Time that the DHRS is engaged
...
// Variable due to flow fraction. (Slow transport = high residency time)
...
// Delayed to simulate transport time between components
    ...
    model PrimaryHeatExchanger
      ...
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_pFluid_PHX = 0.00066065;
      // From Terrapower documents
      // Fuel salt specific heat [MJ/(kg*C)]
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_Tube_PHX = 0.00057779;
      // specific heat capacity of tubes (MJ/(kg-C)) ORNL-TM-0728 p.20
      // PHX Tubing specific heat [MJ/(kg*C)]
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_sFluid_PHX = 0.0011;
      // Secondary salt. See Dunkle_2025 "Dynamic Modeling of a Fast Spectrum Molten Salt Reactor Integrated Energy System" Table 1
...
// Delay for transport time
    ...
    model SecondaryHeatExchanger
      ...
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_pFluid_SHX = 0.0011;
      // See IES paper Table 1 for details
      // Fuel salt specific heat [MJ/(kg*C)]
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_Tube_SHX = 0.00057779;
      // PHX Tubing specific heat [MJ/(kg*C)]
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_sFluid_SHX = 0.00154912;
      // Hitec salt specific heat capacity
      // Coolant salt specific heat [MJ/(kg*C)]
      parameter MCFR_HyS_BOP.Units.MassFlowRate m_dot_pFluidNom_SHX;
      // Fuel salt nominal flow rate
      parameter MCFR_HyS_BOP.Units.MassFlowRate m_dot_sFluidNom_OTSG;
      // Coolant salt nominal flow rate for OTSG subloop
      parameter MCFR_HyS_BOP.Units.MassFlowRate m_dot_sFluidNom_HyS;
      // Coolant salt nominal flow rate for HyS subloop
      ...
      parameter MCFR_HyS_BOP.Units.ResidentTime tauSHXtoHyS = 10;
      // Avg travel time from SHX to HyS
      ...
      MCFR_HyS_BOP.Units.ResidentTime varTauSHXtoHyS;
      MCFR_HyS_BOP.Units.ResidentTime varTauSHXtoPHX;
      MCFR_HyS_BOP.Units.MassFlowRate m_dot_pFluid_SHX;
      MCFR_HyS_BOP.Units.MassFlowRate m_dot_sFluid_OTSG;
      MCFR_HyS_BOP.Units.MassFlowRate m_dot_sFluid_HyS;
      ...
      output MCFR_HyS_BOP.Connectors.Temp_Out T_out_sFluid_OTSG annotation(
        Placement(visible = true, transformation(origin = {-100, -30}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-100, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      output MCFR_HyS_BOP.Connectors.Temp_Out T_out_sFluid_HyS;
      output MCFR_HyS_BOP.Connectors.Temp_Out T_out_pFluid_SHX annotation(
        Placement(visible = true, transformation(origin = {160, 30}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {162, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      input MCFR_HyS_BOP.Connectors.FlowFraction_In secondaryFF annotation(
        Placement(visible = true, transformation(origin = {-70, 50}, extent = {{-18, -18}, {18, 18}}, rotation = 0), iconTransformation(origin = {-70, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      input MCFR_HyS_BOP.Connectors.FlowFraction_In FF_in_sFluid_OTSG annotation(
        Placement(visible = true, transformation(origin = {130, -50}, extent = {{-18, -18}, {18, 18}}, rotation = 0), iconTransformation(origin = {130, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      input MCFR_HyS_BOP.Connectors.FlowFraction_In FF_in_sFluid_HyS;
    initial equation
    ...
    equation
      ...
      m_dot_sFluid_OTSG = m_dot_sFluidNom_OTSG*FF_in_sFluid_OTSG.FF;
      m_dot_sFluid_HyS = m_dot_sFluidNom_HyS*FF_in_sFluid_HyS.FF;
      varTauSHXtoPHX = tauSHXtoPHX/secondaryFF.FF;
      varTauSHXtoOTSG = tauSHXtoOTSG/FF_in_sFluid_OTSG.FF;
      varTauSHXtoHyS = tauSHXtoHyS/FF_in_sFluid_HyS.FF;
...
//Heat transfer to the OTSG
      ...
      m_SN3_SHX*cP_sFluid_SHX*der(T_SN3_SHX) = m_dot_sFluid_OTSG*cP_sFluid_SHX*(T_in_sFluid_OTSG.T - T_SN3_SHX) + hAsn_SHX*(T_TN1_SHX - T_SN3_SHX);
      m_SN4_SHX*cP_sFluid_SHX*der(T_SN4_SHX) = m_dot_sFluid_OTSG*cP_sFluid_SHX*(T_SN3_SHX - T_SN4_SHX) + hAsn_SHX*(T_TN1_SHX - T_SN3_SHX);
//Heat transfer to the HyS
      ...
      m_SN1_SHX*cP_sFluid_SHX*der(T_SN1_SHX) = m_dot_sFluid_HyS*cP_sFluid_SHX*(T_in_sFluid_HyS.T - T_SN1_SHX) + hAsn_SHX*(T_TN2_SHX - T_SN1_SHX);
      m_SN2_SHX*cP_sFluid_SHX*der(T_SN2_SHX) = m_dot_sFluid_HyS*cP_sFluid_SHX*(T_SN1_SHX - T_SN2_SHX) + hAsn_SHX*(T_TN2_SHX - T_SN1_SHX);
      T_out_pFluid_SHX.T = delay(T_PN4_SHX, varTauSHXtoPHX, 5000);
      T_out_sFluid_OTSG.T = delay(T_SN4_SHX, varTauSHXtoOTSG, 5000);
      T_out_sFluid_HyS.T = delay(T_SN2_SHX, varTauSHXtoHyS, 5000);
      P_SecondaryLoop = m_dot_pFluid_SHX*cP_pFluid_SHX*(T_in_pFluid_SHX.T - T_PN4_SHX);
      P_TertiaryLoop = m_dot_sFluid_OTSG*cP_sFluid_SHX*(T_SN4_SHX - T_in_sFluid_OTSG.T) + m_dot_sFluid_HyS*cP_sFluid_SHX*(T_SN2_SHX - T_in_sFluid_HyS.T);
      annotation(
    ...
    model OnceThroughSteamGenerator
      ...
      // Parameter declaration
      parameter MCFR_HyS_BOP.Units.Density rho_hitec = 1680;
      // From http://www.coal2nuclear.com/MSR%20-%20HITEC%20Heat%20Transfer%20Salt.pdf
      parameter MCFR_HyS_BOP.Units.Density rho_tube = 8425.712;
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_hitec = 0.00154912;
      // Hitec salt specific heat [MJ/(kg*C)]
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity cP_Tube_OTSG = 456.056e-6;
      // OTSG Tubing specific heat [MJ/(kg*C)]
      parameter MCFR_HyS_BOP.Units.MassFlowRate m_dot_hitecNom;
      // = 12910.56;//3379; // Hitec salt nominal flow rate
      parameter MCFR_HyS_BOP.Units.MassFlowRate m_dot_fdwNom = 1.925004320027648e+02;
      // Feedwater nominal flow rate
      parameter MCFR_HyS_BOP.Units.Convection h_pw = 9101.343578935E-6;
      // OTSG primary side to tubes heat transfer coefficient [MJ/(s*C)]
      parameter MCFR_HyS_BOP.Units.Convection h_wsh = 5732.378387768E-6;
      // OTSG tubes to superheated steam heat transfer coefficient [MJ/(s*C)]
      parameter MCFR_HyS_BOP.Units.Convection h_wb = 13349.334646671E-6;
      // OTSG tubes to saturated boiling heat transfer coefficient [MJ/(s*C)]
      parameter MCFR_HyS_BOP.Units.Convection h_wsc = 8385.005556375E-6;
      // OTSG tubes to subcooled fluid heat transfer coefficient [MJ/(s*C)]
      parameter MCFR_HyS_BOP.Units.ResidentTime tauOTSGtoSHX;
      // Avg travel time from PHX to SHX
      parameter MCFR_HyS_BOP.Units.Temperature T_PN1_OTSG_initial = 633;
      parameter MCFR_HyS_BOP.Units.Temperature T_PN2_OTSG_initial = 614;
      parameter MCFR_HyS_BOP.Units.Temperature T_PN3_OTSG_initial = 603;
      parameter MCFR_HyS_BOP.Units.Temperature T_PN4_OTSG_initial = 592;
      parameter MCFR_HyS_BOP.Units.Temperature T_PN5_OTSG_initial = 584;
      parameter MCFR_HyS_BOP.Units.Temperature T_PN6_OTSG_initial = 575;
      parameter MCFR_HyS_BOP.Units.Temperature T_TN1_OTSG_initial = 632;
      parameter MCFR_HyS_BOP.Units.Temperature T_TN2_OTSG_initial = 605;
      parameter MCFR_HyS_BOP.Units.Temperature T_TN3_OTSG_initial = 432;
      parameter MCFR_HyS_BOP.Units.Temperature T_TN4_OTSG_initial = 428;
      parameter MCFR_HyS_BOP.Units.Temperature T_TN5_OTSG_initial = 454;
      parameter MCFR_HyS_BOP.Units.Temperature T_TN6_OTSG_initial = 410;
      parameter MCFR_HyS_BOP.Units.Temperature T_SH1_OTSG_initial = 630;
      parameter MCFR_HyS_BOP.Units.Temperature T_SH2_OTSG_initial = 592;
      ...
      parameter MCFR_HyS_BOP.Units.Temperature X_5 = 2.469804064618581e+02;
      // Saturated boiling temperature at zero pressure [C]
      parameter MCFR_HyS_BOP.Units.TsatConstant K_5 = 6.473415732352336;
      // Saturated boiling temperature change per pressure [C/Psat]
      parameter MCFR_HyS_BOP.Units.X_4 X_4 = 1.942396453493191;
      // Hfg = Hg - Hf (Specific enthalpy as a saturated gas/vapor minus specific enthalpy as a saturated fluid)
      parameter MCFR_HyS_BOP.Units.K_4 K_4 = -0.062356611803191;
      // Ptable polyfitted with Hfg_table
      parameter MCFR_HyS_BOP.Units.Number K_sc = 17.615718797133468;
      parameter MCFR_HyS_BOP.Units.Number K_1 = 11.632248097704855;
      // Necessary for the pressure changes. See Vikram Singh's thesis for more information.
      parameter MCFR_HyS_BOP.Units.Number K_b = 12.834854076292217;
      parameter MCFR_HyS_BOP.Units.Length L_sc_initial = 0.3;
      //Length of the subcooled domain
      parameter MCFR_HyS_BOP.Units.Length L_b_initial = 0.3;
      //Length of the boiling domain
      parameter MCFR_HyS_BOP.Units.Length L_sh_initial = 9.4;
      //Length of the superheated domain
      parameter MCFR_HyS_BOP.Units.Length L_OTSG = 10;
      //Total OTSG length. Doesn't change
      parameter MCFR_HyS_BOP.Units.Length D_inner = 0.0141478;
      // Inner diameter of the tubes
      parameter MCFR_HyS_BOP.Units.Length D_outer = 0.015875;
      // Outer diameter of the tubes
      parameter MCFR_HyS_BOP.Units.Area A_flow = 1.2245;
      // Cross-sectional area of flow on secondary side [m^2]
      parameter MCFR_HyS_BOP.Units.Number N_tubes = 10500;
      parameter MCFR_HyS_BOP.Units.Number pi = 2*Modelica.Math.asin(1.0);
      parameter MCFR_HyS_BOP.Units.EnthalpyChange dHs_dPs = -0.042433622114357;
      // Superheated steam Specific enthalpy change per pressure change
      parameter MCFR_HyS_BOP.Units.CompressibilityFactor Z_ss = 0.76634;
      // Compressibility factor at 570K and 60 atm
      parameter MCFR_HyS_BOP.Units.UniversalGasConstant R_ugc = 8.3114462e-6;
      // Universal gas constant [MJ/(mol*C)]
      parameter MCFR_HyS_BOP.Units.MolarMass MM_stm = 0.018;
      // Molar mass of steam
      parameter MCFR_HyS_BOP.Units.Pressure P_setpoint = 12.5;
      // Nominal secondary side pressure [MPa]
      // Variable declaration
      ...
      input MCFR_HyS_BOP.Connectors.Temp_In T_in_hitec_OTSG annotation(
        Placement(transformation(origin = {-170, 30}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-176, 30}, extent = {{-10, -10}, {10, 10}})));
      output MCFR_HyS_BOP.Connectors.Temp_Out T_out_hitec_OTSG annotation(
        Placement(transformation(origin = {160, 30}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {154, 30}, extent = {{-10, -10}, {10, 10}})));
      input MCFR_HyS_BOP.Connectors.FlowFraction_In tertiaryFF annotation(
        Placement(transformation(origin = {-170, 58}, extent = {{-18, -18}, {18, 18}}), iconTransformation(origin = {-176, 58}, extent = {{-10, -10}, {10, 10}})));
      ...
      input MCFR_HyS_BOP.Connectors.FlowRate_In m_dot_fdw annotation(
        Placement(transformation(origin = {-128, -60}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-176, -66}, extent = {{-10, -10}, {10, 10}})));
      output MCFR_HyS_BOP.Connectors.FlowRate_Out m_dot_SH annotation(
        Placement(transformation(origin = {-170, -62}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {154, -66}, extent = {{-10, -10}, {10, 10}})));
...
// Primary Side Nodes
      der(T_PN1)*(N_tubes*pi*(D_inner^2)*0.25*L_sh*0.5*rho_hitec*cP_hitec) = ((m_dot_hitec*cP_hitec*(T_in_hitec_OTSG.T - T_PN1)) + (h_pw*N_tubes*pi*D_inner*L_sh*0.5*(T_TN1 - T_PN1)));
// Primary side node #1 temperature eqn
      der(T_PN2)*(N_tubes*pi*(D_inner^2)*0.25*L_sh*0.5*rho_hitec*cP_hitec) = ((m_dot_hitec*cP_hitec*(T_PN1 - T_PN2)) + (h_pw*N_tubes*pi*D_inner*L_sh*0.5*(T_TN2 - T_PN2)));
// Primary side node #2 temperature eqn
      der(T_PN3)*(N_tubes*pi*(D_inner^2)*0.25*L_b*0.5*rho_hitec*cP_hitec) = ((m_dot_hitec*cP_hitec*(T_PN2 - T_PN3)) + (h_pw*N_tubes*pi*D_inner*L_b*0.5*(T_TN3 - T_PN3)));
// Primary side node #3 temperature eqn
      der(T_PN4)*(N_tubes*pi*(D_inner^2)*0.25*L_b*0.5*rho_hitec*cP_hitec) = ((m_dot_hitec*cP_hitec*(T_PN3 - T_PN4)) + (h_pw*N_tubes*pi*D_inner*L_b*0.5*(T_TN4 - T_PN4)));
// Primary side node #4 temperature eqn
      der(T_PN5)*(N_tubes*pi*(D_inner^2)*0.25*L_sc*0.5*rho_hitec*cP_hitec) = ((m_dot_hitec*cP_hitec*(T_PN4 - T_PN5)) + (h_pw*N_tubes*pi*D_inner*L_sc*0.5*(T_TN5 - T_PN5)));
// Primary side node #5 temperature eqn
      der(T_PN6)*(N_tubes*pi*(D_inner^2)*0.25*L_sc*0.5*rho_hitec*cP_hitec) = ((m_dot_hitec*cP_hitec*(T_PN5 - T_PN6)) + (h_pw*N_tubes*pi*D_inner*L_sc*0.5*(T_TN6 - T_PN6)));
// Primary side node #6 temperature eqn
      T_out_hitec_OTSG.T = delay(T_PN6, varTauOTSGtoSHX, 5000);
//// Tube Nodes
      der(T_TN1)*(N_tubes*pi*(D_outer^2 - D_inner^2)*0.25*L_sh*0.5*rho_tube*cP_Tube_OTSG) = (h_pw*(N_tubes*pi*D_inner*L_sh*0.5)*(T_PN1 - T_TN1) + h_wsh*(N_tubes*pi*D_outer*L_sh*0.5)*(T_SH1.T - T_TN1));
// Tubing node #1 temperature eqn
      der(T_TN2)*(N_tubes*pi*(D_outer^2 - D_inner^2)*0.25*L_sh*0.5*rho_tube*cP_Tube_OTSG) = (h_pw*(N_tubes*pi*D_inner*L_sh*0.5)*(T_PN2 - T_TN2) + h_wsh*(N_tubes*pi*D_outer*L_sh*0.5)*(T_SH2 - T_TN2));
// Tubing node #2 temperature eqn
      der(T_TN3)*(N_tubes*pi*(D_outer^2 - D_inner^2)*0.25*L_b*0.5*rho_tube*cP_Tube_OTSG) = (h_pw*(N_tubes*pi*D_inner*L_b*0.5)*(T_PN3 - T_TN3) + h_wb*(N_tubes*pi*D_outer*L_b*0.5)*(T_sat - T_TN3));
// Tubing node #3 temperature eqn
      der(T_TN4)*(N_tubes*pi*(D_outer^2 - D_inner^2)*0.25*L_b*0.5*rho_tube*cP_Tube_OTSG) = (h_pw*(N_tubes*pi*D_inner*L_b*0.5)*(T_PN4 - T_TN4) + h_wb*(N_tubes*pi*D_outer*L_b*0.5)*(T_sat - T_TN4));
// Tubing node #4 temperature eqn
      der(T_TN5)*(N_tubes*pi*(D_outer^2 - D_inner^2)*0.25*L_sc*0.5*rho_tube*cP_Tube_OTSG) = (h_pw*(N_tubes*pi*D_inner*L_sc*0.5)*(T_PN5 - T_TN5) + h_wsc*(N_tubes*pi*D_outer*L_sc*0.5)*(T_sat - T_TN5));
// Tubing node #5 temperature eqn
      der(T_TN6)*(N_tubes*pi*(D_outer^2 - D_inner^2)*0.25*L_sc*0.5*rho_tube*cP_Tube_OTSG) = (h_pw*(N_tubes*pi*D_inner*L_sc*0.5)*(T_PN6 - T_TN6) + h_wsc*(N_tubes*pi*D_outer*L_sc*0.5)*(T_SC2 - T_TN6));
// Tubing node #6 temperature eqn
//
//// Secondary Side Nodes
      der(T_SH1.T)*(M_sh*0.5*cP_SH1) = (h_wsh*(N_tubes*pi*D_outer*L_sh*0.5)*(T_TN1 - T_SH1.T) + (m_dot_SH.mdot*cP_SH1*(T_SH2 - T_SH1.T)) + (A_flow*L_sh*0.5 + dHs_dPs)*der(P_stm.P));
// Superheated steam node #1 (outlet) temperature eqn
...
// Superheated steam node #2 temperature eqn
      T_sat = X_5 + K_5*P_stm.P;
// Saturated boiling temp eqn
      der(T_SC2) = ((h_wsc*(N_tubes*pi*D_outer*L_sc*0.5)*(T_TN6 - T_SC2) + (cP_fdw*m_dot_fdw.mdot*T_fdw.T) - cP_SC2*((m_dot_fdw.mdot + m_dot_SC)*0.5*T_SC2) + A_flow*L_sc*0.5*der(P_stm.P))*(2/(A_flow*rho_SC2*cP_SC2)) - T_SC2*der(L_sc))*(1/(L_sc));
// Subcooled fluid node temperature eqn
// Secondary side pressure:
      der(P_stm.P)*A_flow*L_sh = ((Z_ss*R_ugc)*(der(M_sh)*(T_SH1.T + T_SH2) + M_sh*(der(T_SH1.T) + der(T_SH2)))/(2*MM_stm)) - (P_stm.P*A_flow*der(L_sh));
// Secondary side pressure. T_sh1 is OTSG outlet. Assumption: P_subcooled = P_saturatedboiling = P_superheated
...
// Density, length, and mass flow rates:
      rho_b = 25.884875705 + 12.835*P_stm.P;
// Two-phase boiling density eqn. See Singh_2020 (https://www.sciencedirect.com/science/article/pii/S0029549319304881)
      der(L_sc) = (1/(A_flow*0.5*rho_SC2*cP_SC2*(T_SC2 - T_sat)))*(h_wsc*N_tubes*pi*D_outer*L_sc*0.5*(T_TN5 - T_sat) + cP_SC2*(m_dot_fdw.mdot*T_SC2 - (m_dot_fdw.mdot + m_dot_SC)*0.5*T_sat) + A_flow*L_sc*0.5*(K_sc*cP_SC2*(T_SC2 - 2*T_sat) - 1)*der(P_stm.P) - (A_flow*rho_SC2*cP_SC2*K_1*L_sc*0.5*der(P_stm.P)));
// Subcooled domain length eqn
      der(L_b)*A_flow*rho_b = m_dot_SC - m_dot_B - (A_flow*L_b*K_b*der(P_stm.P));
// Boiling domain length eqn
      L_sh = L_OTSG - L_b - L_sc;
// Total OTSG length eqn
//  der(L_sh) = -der(L_b) - der(L_sc); // Superheated domain length eqn
      m_dot_SH.mdot = m_dot_fdw.mdot*P_stm.P/P_setpoint;
// Flow rate out of superheated domain (and OTSG)
      m_dot_SC = m_dot_fdw.mdot - (rho_SC2*A_flow*der(L_sc)) - (A_flow*L_sc*K_sc*der(P_stm.P));
// Flow rate out of subcooled domain
      m_dot_B = (h_wb*(N_tubes*pi*D_outer*L_b)*(T_TN3*0.5 + T_TN4*0.5 - T_sat))/(X_4 + K_4*P_stm.P);
// Flow rate out of boiling domain
//  m_dot_SC = 1.925004320027648e+02;
//  m_dot_B = 1.925004320027648e+02;
      der(M_sh) = m_dot_B - m_dot_SH.mdot;
// Rate of steam mass change
    ...
    model RBOP
      ...
      parameter MCFR_HyS_BOP.Units.Number K_RH = 0.2;
      //0.16; //Ratio of steam taken from steam valve for reheat loop
      parameter MCFR_HyS_BOP.Units.Number K_HPB = 0.02;
      //0.1634; //Ratio of high pressure steam bled before turbine for feedwater heater
      parameter MCFR_HyS_BOP.Units.Number K_LPB_initial = 0.12;
      //0.2174; //Ratio of low pressure steam bled before turbine for feedwater heater. Controller changes this
      parameter MCFR_HyS_BOP.Units.Temperature T_setpoint = 180;
      //212; //Desired feedwater temp
      parameter MCFR_HyS_BOP.Units.Temperature T_cool_in = 22;
      //Temp of cooling water for condenser
...
//======================
    ...
    model HyS
      ...
      // ===============
      // DECOMPOSISITION
      parameter MCFR_HyS_BOP.Units.MassFlowRate mdot_H_nom;
      // = 5400;// Mass flow rate of hot fluid on primary side
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity Cp_H = 0.00154912;
      // Hitec salt specific heat [MJ/(kg*C)]
      parameter MCFR_HyS_BOP.Units.SpecificHeatCapacity Cp_W = 7.5e-4;
      // Specific heat of the tubing material (4.35e-4 for Inconel)
      parameter MCFR_HyS_BOP.Units.Mass M_H_node = 5000;
      // Mass of fluid in one of the hot fluid nodes [kg]
      parameter MCFR_HyS_BOP.Units.Mass M_W_node = 500;
      //0.0118;// Mass of one of the wall nodes [kg]
      ...
      parameter MCFR_HyS_BOP.Units.HeatTransferCoeff h_htc = 0.036;
      //1.2e-4;// Heat transfer coefficient
      parameter MCFR_HyS_BOP.Units.Temperature T_boil = 227;
      // Saturated boiling temperature of secondary side [C]
      parameter MCFR_HyS_BOP.Units.EnthalpyOfVaporization Hvap_SA = 0.073331;
      // Energy required to fully boil one mol of sulfuric acid (SA)
      parameter MCFR_HyS_BOP.Units.EnthalpyOfVaporization Hvap_H2O = 0.035970;
      // Energy required to fully boil one mol of water
      parameter MCFR_HyS_BOP.Units.UniversalGasConstant R = 0.00831447/1e3;
      // Universal Gas Constant [MJ/(mol*C)]
      parameter MCFR_HyS_BOP.Units.Temperature T_ref_rxn = 298;
      //[K]
      parameter MCFR_HyS_BOP.Units.Temperature T_ref_Kc = 973;
      //[K]
      parameter MCFR_HyS_BOP.Units.Number epsilon = 0.25;
      parameter MCFR_HyS_BOP.Units.Number Kc = 0.041;
      //0.041;
      parameter MCFR_HyS_BOP.Units.pressure_kPa pressure_nom;
      // = 100;// 1500// Secondary side pressure [kPa]
      parameter MCFR_HyS_BOP.Units.HeatOfReaction H_rxn1 = 0.09753;
      //[MJ/mol]
      parameter MCFR_HyS_BOP.Units.HeatOfReaction H_rxn2 = 0.09889;
      //0.09893;// [MJ/mol]
      parameter MCFR_HyS_BOP.Units.MolarMass MM_SA = 0.0980785;
      // [kg/mol]
      ...
      parameter MCFR_HyS_BOP.Units.Number z = 2;
      // Number of electrons
      parameter MCFR_HyS_BOP.Units.FaradayConstant F = 96485.3399;
      // Coulombs per mol of electrons
      parameter MCFR_HyS_BOP.Units.Volt E0_cell = 0.6;
      // From Gorensek
      parameter MCFR_HyS_BOP.Units.WeightPercent WtP_SA_nom = 0.9;
      parameter MCFR_HyS_BOP.Units.MolFlowRate Mdot_H2O_nom;
      //Nominal excess water flow rate
      parameter MCFR_HyS_BOP.Units.MolFlowRate Mdot_SA_nom;
      //Nominal net sulfur flow rate
      // ~~~
      parameter MCFR_HyS_BOP.Units.Time rampstart;
      parameter MCFR_HyS_BOP.Units.Number ramp_min;
...
// Cold nodes (secondary side)
      T_vap = T_H1 - 2*(T_H1 - T_W1);
//Equation simplifies down to this. See the T_W1 eqn for the energy usage.
      ...
      Q_tot = Q_rxn1 + Q_rxn2 + (mdot_S*Cp_liq*(T_boil - T_liq_in)/Mdot_SO2_out) + (E_dot_boil/Mdot_SO2_out) + (Cp_vap*mdot_S*(T_vap - T_boil)/Mdot_SO2_out);
//HEAT USED PER MOL OF SO2 LIBERATED
// ==========================
...
//  dH_Rx = (H_rxn2 + (-Cp_SO3*MM_SO3 + Cp_SO2*MM_SO2 + 0.5*Cp_O2*MM_O2)*((T_vap + 273.15) - T_ref_rxn))*(1e3);//[kJ/mol] CHECK UNITS
      dH_Rx = H_rxn2 + (-Cp_SO3*MM_SO3 + Cp_SO2*MM_SO2 + 0.5*Cp_O2*MM_O2)*((T_vap + 273.15) - T_ref_rxn);
//[MJ/mol]
...
// =================
// Electrolysis eqns
      dH0 = z*F*E0_cell/1e6 + (T_elec + 273.15)*((S_SA + S_H2) - (S_SO2 + 2*S_H2O));
//Electric energy needed per mol of electrolysis rxn
...
// ~~~
      mdot_H = mdot_H_nom*FF_HyS_Hot.FF;
//Hot salt flow rate
...
// ~~~
      ...
      mdot_H2O_makeup = 2*Mdot_rxn*MM_H2O;
//Add a flow fraction here to modulate the makeup water feed rate
...
//m_PN1UHX * cP_pFluidUHX * der(UHXtemp) = m_dot_pFluidUHX * cP_pFluidUHX * (UHXtemp_In.T - UHXtemp) - UHXP * PowerDemand;
  ...
  package Pumps
    ...
    model HyS_HotLoopPump
      // Hitec Salt Pump parameters and equations
      parameter MCFR_HyS_BOP.Units.FlowFraction freeConvectionFF;
      parameter MCFR_HyS_BOP.Units.PumpConstant HySPumpK;
      parameter MCFR_HyS_BOP.Units.InitiationTime tripHySPump;
      output MCFR_HyS_BOP.Connectors.FlowFraction_Out FF_HyS annotation(
        Placement(visible = true, transformation(origin = {-1.77636e-15, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {1.77636e-15, -60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    initial equation
      FF_HyS.FF = 1;
    equation
      FF_HyS.FF = (1 - freeConvectionFF)*exp(-HySPumpK*delay(time, tripHySPump)) + freeConvectionFF;
      annotation(
        Diagram(graphics = {Rectangle(lineColor = {85, 85, 255}, lineThickness = 1, extent = {{-60, 60}, {60, -60}}), Text(origin = {2, 6}, extent = {{-42, 16}, {42, -16}}, textString = "HyS Hot Side Pump")}),
        Icon(graphics = {Rectangle(origin = {0, -20}, lineColor = {245, 121, 0}, lineThickness = 1, extent = {{-60, 60}, {60, -60}}), Text(origin = {4, -20}, extent = {{-42, 16}, {42, -16}}, textString = "HyS Hot Side Pump")}));
    end HyS_HotLoopPump;

    model OTSG_HotLoopPump
      // Hitec Salt Pump parameters and equations
      parameter MCFR_HyS_BOP.Units.FlowFraction freeConvectionFF;
      parameter MCFR_HyS_BOP.Units.PumpConstant OTSGPumpK;
      parameter MCFR_HyS_BOP.Units.InitiationTime tripOTSGPump;
      output MCFR_HyS_BOP.Connectors.FlowFraction_Out FF_OTSG annotation(
        Placement(visible = true, transformation(origin = {-1.77636e-15, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {1.77636e-15, -60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    initial equation
      FF_OTSG.FF = 1;
    equation
      FF_OTSG.FF = (1 - freeConvectionFF)*exp(-OTSGPumpK*delay(time, tripOTSGPump)) + freeConvectionFF;
      annotation(
        Diagram(graphics = {Rectangle(lineColor = {85, 85, 255}, lineThickness = 1, extent = {{-60, 60}, {60, -60}}), Text(origin = {2, 6}, extent = {{-42, 16}, {42, -16}}, textString = "OTSG Hot Side Pump")}),
        Icon(graphics = {Rectangle(origin = {0, -20}, lineColor = {245, 121, 0}, lineThickness = 1, extent = {{-60, 60}, {60, -60}}), Text(origin = {4, -20}, extent = {{-42, 16}, {42, -16}}, textString = "OTSG Hot Side Pump")}));
    end OTSG_HotLoopPump;
  end Pumps;
